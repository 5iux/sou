...
*/
$.ajax({
    url: 'https://free-api.heweather.net/s6/weather/?location=auto_ip&key=此处请填入自己申请的KEY',
    dataType: 'json',
    error: function() {
    ...
    success: function(res) {
        ...
        $('.wea_hover').css('background-image', 'url(https://cdn.heweather.com/img/plugin/190516/bg/sticker/' + res.HeWeather6[0].now.cond_code + myday + '.png)');
        //今日天气
